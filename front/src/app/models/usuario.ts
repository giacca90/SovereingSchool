...
export class Usuario {
	...
	constructor(_id_usuario: Number, _nombre_usuario: String, _foto_usuario: String[], _roll_usuario: Number, _plan_usuario: Number, _cursos_usuario: Curso[], _fecha_registro_usuario: Date) {
